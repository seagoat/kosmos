...
#
# Generated Thu Aug  2 14:55:51 2018 by generateDS.py version 2.29.19.
...
#
# Command line:
#   /Users/brian/anaconda/bin/generateDS -o "categories.py" ../../schema/categories.xsd
#
...
class categories(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, elementCount=None, category=None):
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from categories import *\n\n')
        sys.stdout.write('import categories as model_\n\n')
